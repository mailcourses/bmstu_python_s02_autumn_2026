# bmstu_python_s02_autumn_2026
Материалы курса Углубленного Python в МГТУ Баумана от VK Education, осень 2026

## Лекции и материалы (слайды, домашки, код с занятий)
01. [Tестирование](lesson-01)
02. [Повторение первого семестра](lesson-02)
03. [Классы, ООП](lesson-03)
04. [Дескрипторы, метапрограммироование](lesson-04)


## Правила оформления домашек на github
* приватный github репозиторий с каким-то связанным с курсом названием (например, bmstu_python_26b_username);
...
* зеленый пайплайн ветки **main** является обязательным.
